...
def add_extra_points(landmark_list):
    ...
    # left_shoulder = landmark_list[0] #landmark_list[11]
    # right_shoulder = landmark_list[1] #landmark_list[12]
    # left_hip = landmark_list[6]#landmark_list[23]
    # right_hip = landmark_list[7]#landmark_list[24]
...
if __name__ == '__main__':
    for i in Complete_pose_Video(video_path="D:\\official\\dataset\\Ai Training Data\\Words\\bye.mp4",debug=True):
        continue
    # for i in Hands_Full(video_path="D:\\official\\dataset\\Ai Training Data\\Words\\alot.mp4"):
    #     continue

    # for i in Pose_Video(video_path="D:\\official\\dataset\\Ai Training Data\\Words\\alot.mp4", debug=True):
    #     continue
#
#     print("finished")
